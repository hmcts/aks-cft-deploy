...
resource "azurerm_network_security_rule" "AllowInternetToOAuthProxy" {
  ...
  network_security_group_name = data.azurerm_resources.aks_nsg.resource_group_name.network_security_group_name
}
...
resource "azurerm_network_security_rule" "TraefikNoProxy" {
  ...
  network_security_group_name = data.azurerm_resources.aks_nsg.name
}